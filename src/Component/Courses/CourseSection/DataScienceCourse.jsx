  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(9, 5, 54, 0.3), rgba(5, 4, 46, 0.7)), url(${dataScienceImage})`,
      ...
      <section className="enroll js-navbar-bg flex flex-col lg:flex-row gap-8 w-4/5 mx-auto py-16">
        <div className="course-preview w-full lg:w-3/4">
          <img
            ...
            alt="Data Science Course Preview"
          />
          <div className="course-info flex justify-between items-start w-full">
            <div className="course-head w-3/4">
              ...
              <div className="stars text-[#DFA410] text-lg mt-2">
                ...
                <FontAwesomeIcon icon={faStar} />
                <FontAwesomeIcon icon={faStar} />
                <span className="number text-gray-500"> (250)</span>
              </div>
              <p className="mt-2 text-gray-500 font-sans leading-snug font-normal">
                Master data science concepts and tools for real-world applications.
              </p>
            </div>
          ...
          <div className="instructor mt-8">
            ...
            <div className="instructor-profile flex items-start mt-8">
              ...
              <div className="instructor-info ml-6">
                ...
                <p className="text-gray-500 text-sm">Data Scientist at DataCorp</p>
              </div>
            </div>
          </div>
          ...
          <div className="course-overview mt-8">
            ...
            <p className="mt-6 text-gray-500 text-sm leading-relaxed text-justify">
              This Data Science course provides a comprehensive understanding of data analysis, machine learning, and data visualization. 
              You will learn how to manipulate data, create algorithms, and derive meaningful insights from complex datasets.
            </p>
          </div>
          ...
          <div className="learn mt-8">
            ...
            <ul className="list-none mt-4">
              <li className="flex items-center mb-4">
                ...
                <span className="ml-6 text-gray-500">Introduction to Data Science</span>
              </li>
              <li className="flex items-center mb-4">
                <i className="fa fa-check-circle text-blue-900"></i>
                <span className="ml-6 text-gray-500">Data Wrangling and Cleaning</span>
              </li>
              <li className="flex items-center mb-4">
                <i className="fa fa-check-circle text-blue-900"></i>
                <span className="ml-6 text-gray-500">Statistical Analysis</span>
              </li>
              <li className="flex items-center mb-4">
                <i className="fa fa-check-circle text-blue-900"></i>
                <span className="ml-6 text-gray-500">Machine Learning Fundamentals</span>
              </li>
              <li className="flex items-center mb-4">
                <i className="fa fa-check-circle text-blue-900"></i>
                <span className="ml-6 text-gray-500">Data Visualization Techniques</span>
              </li>
              <li className="flex items-center mb-4">
                <i className="fa fa-check-circle text-blue-900"></i>
                <span className="ml-6 text-gray-500">Real-world Data Science Projects</span>
              </li>
            </ul>
            <Link
              to="/courses"
