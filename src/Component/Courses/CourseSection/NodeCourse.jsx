  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(9, 5, 54, 0.3), rgba(5, 4, 46, 0.7)), url(${nodeImage})`,
      ...
      <section className="enroll js-navbar-bg flex flex-col lg:flex-row gap-8 w-4/5 mx-auto py-16">
        <div className="course-preview w-full lg:w-3/4">
          ...
          <div className="course-info flex justify-between items-start w-full">
            <div className="course-head w-3/4">
              ...
              <p className="mt-2 text-gray-500 font-sans leading-snug font-normal">
                Learn the fundamentals of Node.js and build scalable applications.
              </p>
            </div>
          ...
          <div className="instructor mt-8">
            ...
            <div className="instructor-profile flex items-start mt-8">
              <img
                ...
                src={profile}
                alt="Instructor Alex Smith"
              />
              <div className="instructor-info ml-6">
                <h3 className="text-lg text-[#30303B] font-sans mt-1">
                  Alex Smith
                </h3>
                <p className="text-gray-500 text-sm">Senior Developer at Google</p>
              </div>
            </div>
          </div>
          ...
          <div className="course-overview mt-8">
            ...
            <p className="mt-6 text-gray-500 text-sm leading-relaxed text-justify">
              This course is designed for beginners to learn how to use Node.js
              effectively. It covers various topics, including the core concepts,
              server-side programming, working with databases, and building
              RESTful APIs. By the end of the course, you will have a strong
              understanding of Node.js and how to build scalable web applications.
            </p>
          </div>
          ...
          <div className="learn mt-8">
            ...
            <ul className="list-none mt-4">
              <li className="flex items-center mb-4">
                ...
                <span className="ml-6 text-gray-500">Introduction to Node.js</span>
              </li>
              <li className="flex items-center mb-4">
                <i className="fa fa-check-circle text-blue-900"></i>
                <span className="ml-6 text-gray-500">Building RESTful APIs</span>
              </li>
              <li className="flex items-center mb-4">
                <i className="fa fa-check-circle text-blue-900"></i>
                <span className="ml-6 text-gray-500">Working with Express.js</span>
              </li>
              <li className="flex items-center mb-4">
                <i className="fa fa-check-circle text-blue-900"></i>
                <span className="ml-6 text-gray-500">Database Integration</span>
              </li>
              <li className="flex items-center mb-4">
                <i className="fa fa-check-circle text-blue-900"></i>
                <span className="ml-6 text-gray-500">Real-time Applications with Socket.io</span>
              </li>
              <li className="flex items-center mb-4">
                <i className="fa fa-check-circle text-blue-900"></i>
                <span className="ml-6 text-gray-500">Deployment Strategies</span>
              </li>
            </ul>
            <Link
              to="/courses"
        ...
        <div className="enroll-info w-full lg:w-[350px] p-6 border border-white shadow-lg h-[500px] mx-auto">
          ...
          {[
            ...
            { icon: faFileAlt, text: "30 articles" },
